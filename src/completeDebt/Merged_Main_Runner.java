...
public class Merged_Main_Runner 
{
  
	public String Calculate_Merged_Report(String Fund_Type) 
	{
//	     String Fund_Type;
		 int i=1,j=1;
...
//					   }
					   ...
					   java.util.Date dd_qtr=arm.getKey().getStart_dt();
			 			...
			 			else if(dd_qtr.getMonth()==9 || dd_qtr.getMonth()==10 ||dd_qtr.getMonth()==11 )
						 {
						  ...
						  ArrayList<nav_hist> dt_lst_r10 = Merged_Main.get_list_of_dates_db_nw( arm.getKey().getStart_dt(), (int)arm.getKey().getScheme_code());
...
//		                           Query get_act_dt = ssn.createQuery("select distinct(from_date) from Calma_Ratio_Model where ");  
					 			  ...
					 			  ArrayList<java.util.Date> tmp_ddt_lst = Merged_Main.get_list_of_dates_Calmar(Merged_Main.get_Date_Corrected(arm.getKey().getStart_dt()) ,arm.getKey().getScheme_code());
