...
import controller.Nav_Rep_3_Sdev_Main;
import model.nav_report_3_Addition;
import sessionFactory.HIbernateSession;

public class Sdev_Report_Runner 
{
	
	public String Calculate_SDev_Report(String Fund_Type)
	{
		Session ssn=null;
						   ...
						   jk=1;
							  ...
							  for(nav_report_3_Addition bb : nr3 )
							  {
								  ...
								  if(jk>36)
								  {
									  ...
									  Nav_Rep_3_Sdev_Main.Save_To_Db_Standard_Deviation(ssn,sc_cd,Fund_Type,12,Sdev_Res12_fl,dte);
									  Nav_Rep_3_Sdev_Main.Save_To_Db_Standard_Deviation(ssn,sc_cd,Fund_Type,24,Sdev_Res24_fl,dte);
									  Nav_Rep_3_Sdev_Main.Save_To_Db_Standard_Deviation(ssn,sc_cd,Fund_Type,36,Sdev_Res36_fl,dte);
