...
@Entity
public class Hybrid_Report_Model 
{
	@EmbeddedId
	Pk_generic key;
	...
	double avg_maturity;
   	...
   	double return_24_months;
   	int return_24_months_rank;
	...
	public double getReturn_24_months() {
		return return_24_months;
	}

	public void setReturn_24_months(double return_24_months) {
		this.return_24_months = return_24_months;
	}

	public int getReturn_24_months_rank() {
		return return_24_months_rank;
	}

	public void setReturn_24_months_rank(int return_24_months_rank) {
		this.return_24_months_rank = return_24_months_rank;
	}
