...
public class Rolling_Return_Main {
...
//			 int loop=0;
			 ...
			 Query q = ssn.createQuery("select key.from_date,key.scheme_code from Custom_Merged_Report_W_Rank where key.Fund_Type='"+Fund_Type+"' order by key.scheme_code, key.from_date");
...
//		         loop++;
	...
	public static void generate_rolling_return(Date date, Integer scheme_code, int year,Rolling_Return rr ,Session ssn) {
...
//			            System.out.println("AUM-->>>"+rs.getDouble(2));
